...
export default function MessengerContactsManager({ compact }: MessengerContactsManagerProps) {
  ...
  return (
    <div className="space-y-4">
      {!compact && (
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Контакты для уведомлений</h2>
          <p className="text-sm text-gray-500 mt-1">
            Привяжите Telegram или MAX один раз. В настройках каждой QR-визитки выберите, кому
            приходят сообщения с формы «Написать человеку».
          </p>
        </div>
      )}
      ...
      {contacts.length > 0 && (
        <Card className={compact ? "p-4" : undefined}>
          <h3 className="font-semibold text-gray-900 mb-3">Подключённые контакты</h3>
      ...
      <Card className={compact ? "p-4" : undefined}>
        <h3 className="font-semibold text-gray-900 mb-3">Добавить контакт</h3>
        <div className="space-y-4">
